...
NOTE: After this step, turn the power supply off. This is very important so you do not damange the ammeter. Also do not adjust the power supply voltage, you'll assume the power supply maintained the same voltage across the resistor during the volt measurements as in the current measurements.
WARNING: DO NOT CONNECT THE POWER SUPPLY IN SERIES WITH THE AMMETER. THIS COULD DAMAGE THE DMM. ![Incorrect configuration. Do not do this](images/no-no-no.png).
