...
*Why this image is here:* It makes the invisible methodological difference visible by showing that prediction and postdiction can look identical in the final graph while meaning very different things.
...
*Why this image is here:* It reinforces the reading's hardest point to internalize: validation credibility comes from when decisions were locked in, not from how neat the final overlap looks.
