...
*Why this image is here:* It makes the trap visible: a better fit statistic can still hide a worse engineering model if the residual structure is trying to tell you something important.
...
*Why this image is here:* It shows why statistical significance and engineering adequacy cannot be collapsed into one yes-or-no judgment.
